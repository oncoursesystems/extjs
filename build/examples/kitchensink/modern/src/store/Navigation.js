...
Ext.define('KitchenSink.store.Navigation', {
    ...
    getNavItemsMaps: function() {
        return {
            ...
            children: [
                { id: 'map-basic', iconCls: 'x-fa fa-map', text: 'Basic', leaf: true, packages: ['kitchensink-google'] }
            ]
        };
    },
    ...
    getNavItemsCarousel: function () {
        return {
            ...
            description: '',
            children: [
                { id: 'carousel-basic', iconCls: 'x-fa fa-ellipsis-h', text: 'Basic Carousel', leaf: true },
                { id: 'carousel-vertical', iconCls: 'x-fa fa-ellipsis-v', text: 'Vertical Carousel', leaf: true }
            ]
        };
    },
    ...
    getNavItemsProgressBars: function () {
        return {
            ...
            description: '',
            children: [
                { id: 'progress-basic', text: 'Basic', leaf: true },
                { id: 'progress-decorated', text: 'Decorated', leaf: true }
            ]
        };
    },
    ...
    getNavItemsPanels: function () {
        return {
            ...
            description: 'Panel is a specialized container that introduces extra functionality such as headers, ' +
                         'resizing and collapsing.',
            children: [
                { id: 'panel-basic', text: 'Basic Panel', leaf: true },
                { id: 'panel-handleresize', text: 'Resizable - Handle', leaf: true, compat: !Ext.platformTags.phone },
                { id: 'panel-splitresize', text: 'Resizable - Split', leaf: true, compat: !Ext.platformTags.phone },
    ...
    getNavItemsDragDrop: function () {
        return {
            ...
            children: [
                ...
                { id: 'drag-file', text: 'Files', iconCls: 'icon-drag-drop-element', leaf: true, compat: Ext.platformTags.desktop }
    ...
    getNavItemsGridBasic: function () {
        return {
            ...
            children: [
                ...
                { id: 'cell-editing', text: 'Cell Editing', leaf: true, compat: Ext.platformTags.desktop },
